...
class DefaultProductDataTest {
    ...
    @Test
    fun shouldInsertProductInTheDatabase() =
        runTest {
    ...
    @Test
    fun shouldUpdateProductInTheDatabase_ifProductExists() =
        runTest {
    ...
    @Test
    fun shouldDeleteProductWithThisIdInTheDatabase_ifProductExists() =
        runTest {
            insertAllProducts()
    ...
    @Test
    fun shouldNotDeleteProductWithThisIdInTheDatabase_ifProductNotExists() =
        runTest {
            productTable.insert(firstProduct, dataVersion, {}, {})
    ...
    @Test
    fun shouldReturnAllProductsInTheDatabase_ifDatabaseIsNotEmpty() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
                productTable.getAll().collect { products ->
    ...
    @Test
    fun shouldReturnProductWithThisId_ifExists() =
        runTest {
            productTable.insert(firstProduct, dataVersion, {}, {})
            launch(Dispatchers.IO) {
    ...
    @Test
    fun shouldReturnLastProduct_ifNotEmpty() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
    ...
    @Test
    fun shouldReturnProductsThatMatchesWithCategorySearch() =
        runTest {
    ...
    @Test
    fun shouldReturnProductsThatMatchesWithNameSearch() =
        runTest {
    ...
    @Test
    fun shouldReturnProductsThatMatchesWithDescriptionSearch() =
        runTest {
    ...
    @Test
    fun shouldReturnProductsThatMatchesWithCompanySearch() =
        runTest {
    ...
    @Test
    fun shouldReturnEmptyList_ifThereIsNothingThatMatchesWithThisSearch() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
    ...
    @Test
    fun shouldReturnAllProducts_ifThisSearchIsEmpty() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
                productTable.search(value = "").collect { products ->
    ...
    @Test
    fun shouldReturnProductsInThisCategoryThatMatchesWithNameSearch() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
    ...
    @Test
    fun shouldReturnProductsInThisCategoryThatMatchesWithDescriptionSearch() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
                productTable.searchPerCategory(
    ...
    @Test
    fun shouldReturnProductsInThisCategoryThatMatchesWithCompanySearch() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
                productTable.searchPerCategory(
    ...
    @Test
    fun shouldReturnEmptyList_ifThereIsNothingThatMatchesWithThisSearchInThisCategory() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
                productTable.searchPerCategory(
    ...
    @Test
    fun shouldReturnAllProducts_ifThisSearchPerCategoryIsEmpty() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
                productTable.searchPerCategory(
    ...
    @Test
    fun shouldReturnAllProductsInThisCategory_ifNotEmpty() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
    ...
    @Test
    fun shouldReturnEmptyList_ifThisCategoryIsEmpty() =
        runTest {
            insertAllProducts()
            launch(Dispatchers.IO) {
