...
internal class DefaultDeliveryRepository @Inject constructor(
    ...
    override suspend fun insert(
        ...
        val id = deliveryData.insert(model = model, version = deliveryVersion, onError = onError) {
    ...
    override suspend fun update(
        ...
        deliveryData.update(model = model, version = deliveryVersion, onError = onError) {
            CoroutineScope(ioDispatcher).launch {
                try {
    ...
    override suspend fun deleteById(
        ...
        deliveryData.deleteById(id = id, version = deliveryVersion, onError = onError) {
            CoroutineScope(ioDispatcher).launch {
                try {
    ...
    override suspend fun syncWith(synchronizer: Synchronizer): Boolean =
        synchronizer.syncData(
            ...
            onPull = { deleteIds, saveList, netVersion ->
                deleteIds.forEach { deliveryData.deleteById(it, netVersion, {}) {} }
                saveList.forEach { deliveryData.insert(it, netVersion, {}) {} }
