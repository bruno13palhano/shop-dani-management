...
class DeliveriesViewModelTest {
    ...
    @Test
    fun getAllDeliveries_shouldCallGetAllFromRepository() =
        runTest {
    ...
    @Test
    fun getAllDeliveries_shouldSetAllDeliveriesToDeliveriesProperty() =
        runTest {
            insertDeliveries()
    ...
    @Test
    fun getDeliveries_shouldCallGetDeliveriesFromRepository() =
        runTest {
            val saleRepository = mock<SaleRepository>()
            val sut = DeliveriesViewModel(saleRepository)
    ...
    @Test
    fun getDeliveries_shouldSetDeliveriesToDeliveriesProperty() =
        runTest {
            insertDeliveries()
