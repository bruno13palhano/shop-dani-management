...
private val items = listOf(
    ...
    Stock(id= 7L, name = "Essencial", photo = "", purchasePrice = 120.45F, quantity = 12),
    Stock(id= 8L, name = "Kaiak", photo = "", purchasePrice = 40.33F, quantity = 2),
    Stock(id= 9L, name = "Homem", photo = "", purchasePrice = 99.99F, quantity = 7),
    Stock(id= 10L, name = "Luna", photo = "", purchasePrice = 12.39F, quantity = 2),
    Stock(id= 11L, name = "Essencial", photo = "", purchasePrice = 56.78F, quantity = 1),
    Stock(id= 12L, name = "Una", photo = "", purchasePrice = 12.12F, quantity = 2)
)